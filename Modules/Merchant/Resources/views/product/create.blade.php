                                ...
                                <div id="nav-tabContent" class="tab-content">
                                    <div class="tab-pane fade show active" id="nav-companyDetail" role="tabpanel" aria-labelledby="nav-companyDetail-tab">
                                        <div class="sl-dashboardbox__content">
                                            <form action="{{ route('merchant.products.store') }}" method="POST" class="sl-form sl-manageServices">
                                                @csrf
                                                <fieldset>
                                                    <div class="sl-form__wrap">
                                                        <div class="form-group form-group">
                                                            <input name="name" class="form-control sl-form-control" type="text" placeholder="Name*" required>
                                                        </div>
                                                        <div class="form-group form-group-half">
                                                            <input name="sku" class="form-control sl-form-control" type="text" placeholder="SKU*" required>
                                                        </div>

                                                        <div class="form-group form-group-half">
                                                            <input name="price" class="form-control sl-form-control" type="text" placeholder="Price" required>
                                                        </div>
                                                        <div class="form-group form-group-half">
                                                        ...
                                                        <div class="form-group sl-btnarea">
                                                            <input type="submit" class="btn sl-btn">
