                ...
                <div class="sl-category sl-row">
                    <div class="sl-col sl-col-sm-1-of-2 sl-col-md-1-of-3 sl-col-lg-1-of-4 sl-col-xl-1-of-5">
                        <div class="sl-category__service">
                            <img src="{{asset('frontend/images/index/category/img-01.jpg')}}" alt="image Description">
        ...
        <section class="sl-main-section">
            ...
            <div id="slCategoryOwl" class="owl-carousel owl-theme sl-owl-nav">
                <div class="item">
                    <div class="sl-slider">
                        <figure>
                            <a href="javascript:void(0);"><img src="{{asset('frontend/images/index/service-provider/img-01.jpg')}}" alt="Image Description"></a>
                            <a href="javascript:void(0);"><img src="{{asset('frontend/images/index/service-provider/user-icon/img-01.jpg')}}" alt="Image Description"></a>
