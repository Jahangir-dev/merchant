                            ...
                            <div id="nav-tabContent" class="tab-content">
                                <div class="tab-pane fade show active" id="nav-companyDetail" role="tabpanel" aria-labelledby="nav-companyDetail-tab">
                                    <div class="sl-dashboardbox__content">
                                        <form action="{{route('merchant.profile.basic.update')}}" method="POST" class="sl-form sl-manageServices" enctype="multipart/form-data">
                                            @csrf
                                            <fieldset>
                                ...
                                <div class="tab-pane fade" id="nav-aboutDescription" role="tabpanel" aria-labelledby="nav-aboutDescription-tab">
                                    <div class="sl-dashboardbox__content sl-aboutDescription">
                                        <form action="{{route('merchant.profile.about.update')}}" method="POST" class="sl-form sl-manageServices">
                                            @csrf
                                            <fieldset>
                                                <div class="sl-form__wrap">
                                                    ...
                                                    <div class="sl-aboutDescription__content">
                                                        <div class="form-group">
                                                            ...
                                                            <label class="sl-aboutDescription__inputBtn">
                                                                <select name="languages[]" id="sl-languages" class="form-control sl-form-control" multiple="multiple">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="sl-manageServices__upload">
                                                                <div class="sl-manageServices__uploadarea">
                                                                    <span><i class="fas fa-cloud-upload-alt"></i></span>
                                                                    <h5>Merchant Logo</h5>
                                                                    <p>Drop image here or click <label for="file3">
                                                                            <span>
                                                                                <input id="file3" type="file" name="file"> upload</span>
                                                                        </label> <i class="far fa-question-circle toltip-content tipso_style" data-tipso="name"></i></p>
                                                                    <svg>
                                                                        <rect width="100%" height="204px"></rect>
                                                                    </svg>
                                                                </div>
                                ...
                                <div class="tab-pane fade" id="nav-gallery" role="tabpanel" aria-labelledby="nav-gallery-tab">
                                    <div class="sl-dashboardbox__content sl-aboutDescription sl-galleryTab">
                                        <form action="{{route('merchant.profile.media.update')}}" method="POST" class="sl-form sl-manageServices"  enctype="multipart/form-data">
                                            @csrf
                                            <fieldset>
                                                <div class="sl-form__wrap">
                                                    <div class="form-group">
                                                            ...
                                                            <div class="sl-row">
                                                                <div class="sl-col-1-of-2 sl-col-md-1-of-3 sl-col-xl-1-of-4">
                                                                    <figure class="sl-galleryTab__gallery--item">
                                                                        <img src="{{asset('frontend/images/profile-settings/gallery/img-01.jpg')}}" alt="Image Description">
                                                                        <a class="sl-deleteImg" href="javascript:void(0);"><i class="fas fa-times"></i>Delete</a>
                                                                    </figure>
                                                                </div>
                                                                <div class="sl-col-1-of-2 sl-col-md-1-of-3 sl-col-xl-1-of-4">
                                                                    <figure class="sl-galleryTab__gallery--item">
                                                                        <img src="{{asset('frontend/images/profile-settings/gallery/img-02.jpg')}}" alt="Image Description">
                                                                        <a class="sl-deleteImg" href="javascript:void(0);"><i class="fas fa-times"></i>Delete</a>
                                                                    </figure>
                                                                </div>
                                                                <div class="sl-col-1-of-2 sl-col-md-1-of-3 sl-col-xl-1-of-4">
                                                                    <figure class="sl-galleryTab__gallery--item">
                                                                        <img src="{{asset('frontend/images/profile-settings/gallery/img-03.jpg')}}" alt="Image Description">
                                                                        <a class="sl-deleteImg" href="javascript:void(0);"><i class="fas fa-times"></i>Delete</a>
                                                                    </figure>
                                                                </div>
                                                                <div class="sl-col-1-of-2 sl-col-md-1-of-3 sl-col-xl-1-of-4">
                                                                    <figure class="sl-galleryTab__gallery--item">
                                                                        <img src="{{asset('frontend/images/profile-settings/gallery/img-07.jpg')}}" alt="img description">
                                                                        <a class="sl-deleteImg" href="javascript:void(0);"><i class="fas fa-times"></i>Delete</a>
                                                                    </figure>
                                                                </div>
                                                                <div class="sl-col-1-of-2 sl-col-md-1-of-3 sl-col-xl-1-of-4">
                                                                    <figure class="sl-galleryTab__gallery--item">
                                                                        <img src="{{asset('frontend/images/profile-settings/gallery/img-05.jpg')}}" alt="Image Description">
                                                                        <a class="sl-deleteImg" href="javascript:void(0);"><i class="fas fa-times"></i>Delete</a>
                                                                    </figure>
                                                                </div>
                                                            </div>
