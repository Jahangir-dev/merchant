<div class="tile">
    <form action="{{ route('admin.settings.update') }}" method="POST" role="form">
        @csrf
        <h3 class="tile-title">{{translateText('Analytics')}}</h3>
        <hr>
        <div class="tile-body">
            <div class="form-group">
                <label class="control-label" for="google_analytics">{{translateText('Google Analytics Code')}}</label>
                <textarea
                    class="form-control"
                    rows="4"
            ...
            <div class="form-group">
                <label class="control-label" for="facebook_pixels">{{translateText('Facebook Pixel Code')}}</label>
                <textarea
                    class="form-control"
                    rows="4"
