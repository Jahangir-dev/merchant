<div class="tile">
    <form action="{{ route('admin.settings.update') }}" method="POST" role="form" enctype="multipart/form-data">
        @csrf
        <h3 class="tile-title">{{translateText('Site Logo')}}</h3>
        <hr>
        <div class="tile-body">
            <div class="row">
                <div class="col-3">
                ...
                <div class="col-9">
                    <div class="form-group">
                        <label class="control-label">{{translateText('Site Logo')}}</label>
            ...
            <div class="row mt-4">
                ...
                <div class="col-9">
                    <div class="form-group">
                        <label class="control-label">{{translateText('Site Favicon')}}</label>
