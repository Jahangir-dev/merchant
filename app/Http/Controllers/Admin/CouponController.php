...
class CouponController extends Controller
{
	...
	{		
		...
		$all_users = User::get()->pluck('first_name','id');
		
		$all_category = Category::all()->pluck('name','id');

		return view('admin.coupon.create', compact('all_users','all_category'));
	}
	...
	{		
		...
		$all_users = User::all()->pluck('first_name','id');
		$all_category = Category::all()->pluck('name','id');		
		return view('admin.coupon.edit', compact('coupon','all_users','all_category'));
	}
